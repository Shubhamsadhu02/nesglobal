                ...
                <div className="container mb-15 mt-15" >
                    ...
                    <div className="terms-paragrapgh">
                        <p style={{ color: "#737171" }}>
                            ...
                            <br />
                            <br />
                            2.4 Duration: For Nes Global Visibility Services, Customer will be able to access www.nesglobal.in pursuant to the Service Plan (defined below) for which it has subscribed. For all other Services, Customers will be able to access such Services for the period such Services are utilized or as otherwise communicated by Company.
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            4.7 In the event Customer requests from Company to remove their User Content, Company will do so taking into account its administrative obligations under law. The retention period for custom information and associated documentation in the EU and US is respectively seven (7) and five (5) years.
                            ...
                            <br />
                            <br />
                            12.2 In the event that a claim arises from activities relating to the Services including the Nes Global Visibility Services, and to the extent that Section 9 above, Section 12.1 above, and/or any other applicable limitation of liability in the Company’s Terms and Conditions is, for any reason, determined to be unenforceable or inapplicable, the Company’s liability shall be limited to either the lesser of the fees Customer paid to Company for such services and INR 5000 per occurrence, with an absolute per annum cap of  INR50,000 (regardless of the number of occurrences) if the Customer was receiving such services on a paying subscription basis; or INR1000.00 maximum per annum, regardless of the number of occurrences, if the Customer was not receiving such services on a paying subscription basis.
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            Company will process all personal information in accordance with its privacy policy available at https://www.nesglobal.in/privacy/. By using the Services, Customer consents to Company's collection, use, and disclosure of information as set forth in Company's privacy policy. Company may update that policy from time to time.
                            <br />
                            <br />
                            16. GOVERNING LAW
                            <br />
