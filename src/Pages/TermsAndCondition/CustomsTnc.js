...
export default function CustomsTnc() {
    return (
        <>
            <Header />
            ...
            <section>
                <div className="container mb-15" style={{ padding: "10rem 6rem 0 6rem" }}>
                    ...
                    <div className="terms-heading">
                        <h1>Nes Global Customs Brokerage and General Terms &amp; Conditions</h1>
                    </div>
                    <div className="terms-paragrapgh">
                        <p style={{ color: "#737171" }}>
                            ...
                            <div className="terms-subheading mt-3">
                                <h3 style={{ color: "#403F3E" }}>DEFINITIONS AND APPLICATION</h3>
                            </div>
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            <b>CUSTOMS HOUSE AGENT</b> – Company acting in the name of and on behalf of the Customer and/or Owner with Indian Customs and Port /Airport Authorities, any such other Competent Authority as a Custom House Agent.
                            <br />
                            <br />
                            <b>FREIGHT FORWARDER</b> – Company, when rendering services of forwarding of goods after the Customs clearance, on behalf of their customer.
                            <br />
                            <br />
                            <b>WAREHOUSING SERVICE PROVIDER</b> – Company when rendering services of warehousing for facilitating storage of goods and other activities ancillary and / or incidental to warehousing.
                            <br />
                            <br />
                            <b>TRANSPORTER</b> – Company when providing their own trucks for transportation of the goods.
                            <br />
                            <br />
                            <b>GOODS</b> – Cargo to which any business under these conditions relates to.
                            <br />
                            <br />
                            <b>PERSON</b> – Natural person(s) or anybody or bodies corporate.
                            <br />
                            <br />
                            <b>TRANSPORT UNIT</b> – Packing case, pallets, container, trailer, tanker, or any other device used whatsoever for and in connection with the carriage of Goods by land, sea or by air.
                            <br />
                            <br />
                            ...
                            <br />
                            <div className="terms-subheading mt-3">
                                <h3 style={{ color: "#403F3E" }}>THE COMPANY WARRANTS</h3>
                            </div>
                            <br />
                            <br />
                            ...
                            <br />(i) Has a general lien and a right to detention over all goods and documents relating to goods in its possession, custody or control for all sums due at any time to the Company from the Customer or Owner, on any account whatsoever, whether relating to goods belonging to or services provided by or on behalf of the Company to the Customer or Owner. Storage charges shall continue to accrue on any goods detained under lien and such charges shall be payable by the Customer or Owner to the Company.
                            <br />(ii) Shall be entitled on at least 15 days notice in writing to the Customer, to sell or dispose of or deal with such goods or documents relating to goods at the expense of the Customer and apply the proceeds in or towards the payment of such sums;
                            <br />(iii) Shall upon accounting to the Customer for any balance remaining after payment of any sum(s) due to the Company, and for the cost of sale and/or disposal and/or dealing, be discharged of any liability whatsoever in respect of the goods or documents to the goods and the right exercised under this clause shall not be deemed to have been waiver of the Company’s right to take further legal steps to recover the dues.
                            <br />
                            <br />
                            ...
                            <br />
                            <div className="terms-subheading mt-3">
                                <h3 style={{ color: "#403F3E" }}>THE CUSTOMER WARRANTS</h3>
                            </div>
                            <br />
                            <br />
                            ...
                            <br />
                            <div className="terms-subheading mt-3">
                                <h3 style={{ color: "#403F3E" }}>LIABILITY AND LIMITATION</h3>
                            </div>
                            <br />
                            <br />
                            ...
                            <br/>(a) The Company is liable only for the faults attributable to itself or it’s employees.
                            <br/>(b) The Company shall not be liable to the customer for consequential loss or loss market howsoever caused.
                            <br/>(c) The Company shall not be liable for acts or omissions for third parties such as re-forwarders, carrier etc. provided it has shown due diligence in the choice of such third parties. If it can be proved that the Company has not done so, its liability shall not exceed that of any third party held liable, whom it had contracted with.
                            <br/>(d) The liability of the Company for the loss of or damage to goods will be fixed on the basis of the market value of the goods at the time of acceptance by the Company and will not under any circumstances, exceed that market value or a sum at the rate of Rs. 14/- per kilo of the gross weight of the goods lost or damaged, whichever is less, subject to a maximum of Rs. 15,000/- for each occurrence of loss.
                            <br/>(e) The Company may arrange/provide road transport for the customer and in such event the Company shall not be held responsible as a carrier or assume the liability of a carrier.
                            <br/>(f) In the event of the liability of the Company being sought to be varied, the variation shall only be affected by a written document signed by the Company. In the absence of such a document the liability of the Company shall be governed as provided herein.
                            <br />
                            <br />
                            ...
                            <br/>
                            <div className="terms-subheading mt-3">
                                <h3 style={{ color: "#403F3E" }}>ARBITRATION</h3>
                            </div>
                            <br />
                            <br />
                            ...
                            <br/>
                            <div className="terms-subheading mt-3">
                                <h3 style={{ color: "#403F3E" }}>JURISDICTION AND LAW</h3>
                            </div>
                            <br />
                            <br />
